...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-414-sets-with-distinct-subset-sums-69749304-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-414"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-414-sets-with-distinct-subset-sums-69749304-v1",
      "problem_contract_sha256": "1e048ddb5d33cc3037adbf75f710be3ccebd36e3432c33cb7e314d71476de893",
      "problem_id": "problem:um-opg-414-sets-with-distinct-subset-sums-69749304",
      "route_id": "route:um-opg-414-sets-with-distinct-subset-sums-69749304-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-414-sets-with-distinct-subset-sums-69749304-source-fidelity-01",
      "graph_id": "graph:um-opg-414-sets-with-distinct-subset-sums-69749304-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-414-sets-with-distinct-subset-sums-69749304-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-414-sets-with-distinct-subset-sums-69749304-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Say that a set $S \\subseteq {\\mathbb Z}$ has distinct subset sums if distinct subsets of $S$ have distinct sums. Conjecture There exists a fixed constant $c$ so that $|S| \\le \\log_2(n) + c$ whenever $S \\subseteq \\{1,2,\\ldots,n\\}$ has distinct subset sums."
          },
          "statement_sha256": "85c1640fb6233868b4fd42c73d67ef7864c9db1f509032ffbebe8800c68a50d2"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-414-sets-with-distinct-subset-sums-69749304-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-414-sets-with-distinct-subset-sums-69749304-root",
      "route_id": "route:um-opg-414-sets-with-distinct-subset-sums-69749304-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-414-a98f3dee9c1b",
        "url": "https://www.unsolvedmath.com/problems/OPG-414"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
